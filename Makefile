...
CORE_OBJS = ds4.o ds4_metal.o ds4_turbo.o
CPU_CORE_OBJS = ds4_cpu.o ds4_turbo.o
else
...
CORE_OBJS = ds4.o ds4_cuda.o ds4_turbo.o
CPU_CORE_OBJS = ds4_cpu.o ds4_turbo.o
METAL_LDLIBS := $(LDLIBS)
endif
...
ds4_turbo.o: ds4_turbo.c ds4_turbo.h
	$(CC) $(CFLAGS) -c -o $@ ds4_turbo.c
